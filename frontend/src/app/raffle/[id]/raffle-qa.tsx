    ...
    <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden">
      ...
      {isExpanded && (
        <div className="border-t border-white/10">
          ...
          {canAsk && (
            <form onSubmit={handleAskQuestion} className="p-4 border-b border-white/10">
          ...
          {!isAuthenticated && isRaffleActive && (
            <div className="p-4 border-b border-white/10 text-center text-gray-400">
                ...
                <div key={question.id} className="p-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 mt-1">{question.content}</p>
                    </div>
                  </div>
                    ...
                    <div className="mt-3 ml-11 pl-4 border-l-2 border-purple-500/30">
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-300 mt-1">{question.answer.content}</p>
                        </div>
                      </div>
                    </div>
                  ) : isSeller ? (
